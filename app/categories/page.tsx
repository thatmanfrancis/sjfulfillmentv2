            ...
            <div className="relative">
              ...
              {openActionFor === category.id && (
                <div ref={actionMenuRef} className="absolute right-0 mt-2 w-40 bg-gray-800 border border-gray-700 rounded shadow-lg z-50">
                  <button onClick={() => openEdit(category)} className="w-full text-left px-4 py-2 hover:bg-gray-700 text-white flex items-center" title="Edit">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                    Edit
                  </button>
                  <button onClick={() => openDelete(category)} className="w-full text-left px-4 py-2 hover:bg-gray-700 text-red-400 flex items-center" title="Delete">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {openActionFor && actionMenuPos && (() => {
        ...
        return ReactDOM.createPortal(
          <div style={{ position: 'absolute', left: actionMenuPos.x, top: actionMenuPos.y, width: 160 }} className="bg-gray-800 border border-gray-700 rounded shadow-lg z-50">
            <button onClick={() => { openEdit(cat); setOpenActionFor(null); }} className="w-full text-left px-4 py-2 hover:bg-gray-700 text-white flex items-center" title="Edit">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg>
              Edit
            </button>
            <button onClick={() => { openDelete(cat); setOpenActionFor(null); }} className="w-full text-left px-4 py-2 hover:bg-gray-700 text-red-400 flex items-center" title="Delete">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              Delete
